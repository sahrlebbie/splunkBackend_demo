define([
    ...
    'app/views/anomaly_detection/Config'
             ...
             mvc,
             SystemConfig) {
    const SplunkVisualizationBase = index.SplunkVisualizationBase;
    var tokens = {},
    ...
    return SplunkVisualizationBase.extend({
        ...
        setupView: function () {
            ...
            this.managerDialog = new ManagerDialog();
            this.managerDialog.render().appendTo($('body'));
            $('#schedule_job_button:not(disabled)').click((function () {
                this.managerDialog.fetchJobs();
            }).bind(this));
        },
        ...
        updateView: function (data, config) {
            if (_.isEmpty(data)) {
                ...
                this.managerDialog.setJobParams(params, data.mode);
            }
        }
    });
});
