define([
    ...
    const SplunkUtil = index.splunkUtils;
    const SharedModels = index.SharedModels;
    const BaseView = index.BaseView;
    const ReportModel = index.ReportModel;
    const ModAlertActionsCollection = index.ModAlertActionsCollection;
    const CreateAlertView = index.CreateAlertView;
    const EditAlertView = index.EditAlertView;
