...
], function ($, _, Backbone, mvc, LookupUtil, TokenHelper, SearchManager, SearchUtil, TokenForwarder, SearchQueueManager, Helper, Config, TableConfig, BillingUtil, index, RIPlannerExistingRITemplate, RIPlannerOptimalRITemplate) {
    'use strict';
