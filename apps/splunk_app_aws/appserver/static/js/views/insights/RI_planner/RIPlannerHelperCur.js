...
], function ($, _, index, Config) {
    'use strict';
    const moment = index.moment;
    let RIPlannerHelperCur = {
        ...
        generateRISPL: function (params) {
            return RIPlannerHelperCur.generateIHSPL(params) + RIPlannerHelperCur.generateRecommSPL(params);
        },
        ...
        timeToIndex: function (time) {
            return Math.floor((time - RIPlannerHelperCur.start.getTime()) / Config.ONE_DAY_MIS);
        },
