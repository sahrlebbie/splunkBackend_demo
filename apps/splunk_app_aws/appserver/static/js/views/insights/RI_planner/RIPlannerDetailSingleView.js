define([
...
], function ($, _, Backbone, mvc, index, Helper, Config, OptimalRITooltipTemplate, RIDetailFormulaTooltipTemplate) {
    ...
    return BaseView.extend({
        ...
        formatData: function () {
            ...
            if (this.tokens && submitTokens) {
                submitTokens.set(this.tokens.toJSON());
            }
        },
