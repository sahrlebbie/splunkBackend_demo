...
def get_supported_description_apis():
    from . import ec2_description as ade
    from . import elb_description as aed
    from . import vpc_description as avd
    from . import cloudfront_description as acd
    from . import rds_description as ard
    from . import lambda_description as ald
    from . import s3_description as asd
    from . import iam_description as aid
