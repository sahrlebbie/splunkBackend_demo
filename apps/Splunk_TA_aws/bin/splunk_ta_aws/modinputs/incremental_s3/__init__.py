...
class AWSLogsDataInput(object):
    ...
    def create_credentials(self, config):
        ...
        sts_endpoint_url = tacommon.get_endpoint_url(self._stanza.content, "sts_private_endpoint_url")
        factory = AWSCredentialsProviderFactory(config,self._stanza.content.get('aws_s3_region'), sts_endpoint_url)
    ...
    def create_bucket(self):
        ...
        args = self._extract(parser)
        s3_endpoint_url = tacommon.get_endpoint_url(self._stanza.content, "s3_private_endpoint_url")
