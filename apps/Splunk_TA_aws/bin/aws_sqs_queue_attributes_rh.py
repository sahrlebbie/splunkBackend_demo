...
class SqsQueueAtrributesHandler(splunk.admin.MConfigHandler):
    ...
    def handleList(self, confInfo):
        ...
        if int(self.callerArgs.data.get('private_endpoint_enabled',[0])[0]):
            endpoint_urls = {
                "sqs_private_endpoint_url" : self.callerArgs.data.get('sqs_private_endpoint_url')[0],
                "sts_private_endpoint_url" : self.callerArgs.data.get('sts_private_endpoint_url')[0],
            }
